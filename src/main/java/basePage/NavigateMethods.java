...
public class NavigateMethods extends CreateDriver implements BaseTest1 {
    ...
    public void navigate(String direction) {
        if (direction.equals("back"))
            CreateDriver.getInstance().getDriver().navigate().back();
        else
            CreateDriver.getInstance().getDriver().navigate().forward();
    }
